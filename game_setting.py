...
BULLETFIRED_SOUND = pygame.mixer.Sound(os.path.join('resources/sounds','laser_shot.wav'))
GAMEOVER_SOUND = pygame.mixer.Sound(os.path.join('resources/sounds', 'game_over.wav'))
PUDDLEGIFT_SOUND  = pygame.mixer.Sound(os.path.join('resources/sounds', 'puddle_gift_collision.wav') )
...
# IMAGES
SCALE = 0.6
BACKGROUNG_IMG = pygame.image.load(os.path.join('resources/images', 'background.jpg'))
